...
| --- | --- | --- |
| `t-087-exclude-service-tabs-from-activity-labels` | Exclude service tabs from terminal activity labels | 2026-05-09 |
...
| `t-055-classic-t050-palette` | Restore Classic to the T050 color baseline | 2026-05-08 |
